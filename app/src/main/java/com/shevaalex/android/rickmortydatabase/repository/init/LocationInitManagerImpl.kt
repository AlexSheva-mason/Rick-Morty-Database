...
constructor(
    ...
    override suspend fun getListFromNetwork(token: String): ApiResult<List<LocationModel?>> {
    ...
    override suspend fun filterNetworkList(networkList: List<LocationModel>): List<LocationModel> {
    ...
    override suspend fun saveNetworkListToDb(networkList: List<LocationModel>) {
